// BEGIN FIRST HOUSES OVERLOAD
var houses_overload = true;
var houseCounter = 0;
var houses = [
				{ name: 'Wozniak', members:
				   	[ 
						'Isaac Lee',
						'Anirudha Dasgupta',
						'Moon Ahmed',
  				...
  				{ name: 'Matsumoto', members:
				   	[ 
						'Weiqing Su',
						'Joe Misseri',
						'Alan Ng',
						'Nicholas R Strickland',
						'Ashley Sosnicki',
						'Ramon Vizcarra',
						'Hanna Kim',
						'Darrick Chung',
						'Trevor Leonard Traylor',
						'Tyler Silverman',
						'Kyle De Koerber',
						'Steven Iam',
						'Ahmad Safi',
  				...
  				{ name: 'Newell', members: 
					[ 
						...
						'Melinda Po',
						'Zulfi Faiz',
						'Subbi Rami Reddy Seelam',
						'Tarini Challa',
						'Kelly Howard',
						'Thomas Leupp',
						'Conrad Hiu-kwong Wong',
						'Hesham',
						'Michelle' 
					]
				},
...
// BEGIN HOUSES OVERLOAD
	if(houses_overload) {
		console.log('overloaded');

		houseCounter == 0 ? houseCounter+=2 : houseCounter = 0;

	// house 1
		$scope.currentlyDisplayedHouseName1 = houses[houseCounter].name;
		$scope.currentlyDisplayedMembers1 = houses[houseCounter].members;		
	// house 2
		$scope.currentlyDisplayedHouseName2 = houses[houseCounter + 1].name;
		$scope.currentlyDisplayedMembers2 = houses[houseCounter + 1].members;
...
// END HOUSES OVERLOAD
	...
	mirrorBrain();
	$interval( mirrorBrain, 10000); // originally 1200000
